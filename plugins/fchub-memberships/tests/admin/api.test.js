...
const cases = [
  ...
  ['members.extend', () => members.extend({ user_id: 21, plan_id: 5, expires_at: '2026-04-01 23:59:59' }), 'POST', '/admin/members/extend'],
  ...
  ['members.bulkExtend', () => members.bulkExtend({ user_ids: [21], plan_id: 5, expires_at: '2026-04-01 23:59:59' }), 'POST', '/admin/members/bulk-extend'],
  ...
  ['settings.revokeApiKey', () => settings.revokeApiKey(), 'POST', '/admin/settings/revoke-api-key'],
  ['settings.regenerateWebhookSecret', () => settings.regenerateWebhookSecret(), 'POST', '/admin/settings/regenerate-webhook-secret'],
  ['settings.getWebhookHealth', () => settings.getWebhookHealth(), 'GET', '/admin/webhooks/health'],
  [
    'settings.listWebhookDeliveries',
    () => settings.listWebhookDeliveries({ page: 2, per_page: 20, status: 'failed' }),
    'GET',
