...
class TrialExpiredTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fchub_memberships/trial_expired';
        $this->priority = 20;
        // Actual hook fires: do_action('fchub_memberships/trial_expired', $grant)
        $this->actionArgNum = 1;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Trial Expired Without Conversion', 'fchub-memberships'),
            'description' => __('This will start when a trial expires without converting to a paid membership', 'fchub-memberships'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Trial Expired Without Conversion', 'fchub-memberships'),
            'sub_title' => __('This will start when a trial expires without converting to a paid membership', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
