...
class TrialConvertedTrigger extends BaseTrigger
{
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Trial Converted to Paid', 'fchub-memberships'),
            'description' => __('This will start when a trial membership converts to a paid subscription', 'fchub-memberships'),
        ];
    }
    ...
    public function getSettingsFields($funnel)
    {
        return [
            ...
            'sub_title' => __('This will start when a trial membership converts to a paid subscription', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
    ...
    {
        // Hook signature: ($grant, $planId, $userId)
