...
class MembershipResumedTrigger extends BaseTrigger
{
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Membership Resumed', 'fchub-memberships'),
            'description' => __('This will start when a paused membership is resumed', 'fchub-memberships'),
        ];
    }
    ...
    public function getSettingsFields($funnel)
    {
        return [
            ...
            'sub_title' => __('This will start when a paused membership is resumed', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
