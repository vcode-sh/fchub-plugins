...
class MembershipRevokedTrigger extends BaseTrigger
{
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Membership Plan Revoked', 'fchub-memberships'),
            'description' => __('This will start when a membership plan is revoked from a user', 'fchub-memberships'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Membership Plan Revoked', 'fchub-memberships'),
            'sub_title' => __('This will start when a membership plan is revoked from a user', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
