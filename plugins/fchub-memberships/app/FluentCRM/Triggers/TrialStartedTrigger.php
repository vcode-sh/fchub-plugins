...
class TrialStartedTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fchub_memberships/trial_started';
        $this->priority = 20;
        $this->actionArgNum = 3;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Trial Started', 'fchub-memberships'),
            'description' => __('This will start when a user begins a trial membership', 'fchub-memberships'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Trial Started', 'fchub-memberships'),
            'sub_title' => __('This will start when a user begins a trial membership', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
    ...
    {
        // Hook signature: ($context, $planId, $userId)
