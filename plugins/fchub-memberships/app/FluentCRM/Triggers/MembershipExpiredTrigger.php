...
class MembershipExpiredTrigger extends BaseTrigger
{
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Membership Expired', 'fchub-memberships'),
            'description' => __('This will start when a membership grant expires', 'fchub-memberships'),
        ];
    }
    ...
    public function getSettingsFields($funnel)
    {
        return [
            ...
            'sub_title' => __('This will start when a membership grant expires', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
