...
class TrialExpiringSoonTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fchub_memberships/trial_expiring_soon';
        $this->priority = 20;
        $this->actionArgNum = 2;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Trial Expiring Soon', 'fchub-memberships'),
            'description' => __('This will start when a trial membership is about to expire', 'fchub-memberships'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Trial Expiring Soon', 'fchub-memberships'),
            'sub_title' => __('This will start when a trial membership is about to expire', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
    ...
    public function getConditionFields($funnel)
    {
        return [
            ...
            'min_days_left' => [
                ...
                'inline_help' => __('Only trigger if at least this many trial days remain. Leave blank for no minimum.', 'fchub-memberships'),
            ],
            'max_days_left' => [
                'type'        => 'input-number',
                'label'       => __('Maximum Days Left', 'fchub-memberships'),
                'placeholder' => __('e.g. 7', 'fchub-memberships'),
                'inline_help' => __('Only trigger if no more than this many trial days remain. Leave blank for no maximum.', 'fchub-memberships'),
            ],
            'run_multiple'  => [
                'type'        => 'yes_no_check',
                'label'       => '',
