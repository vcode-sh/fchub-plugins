...
class DripContentUnlockedTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fchub_memberships/drip_unlocked';
        $this->priority = 20;
        $this->actionArgNum = 3;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Drip Content Unlocked', 'fchub-memberships'),
            'description' => __('This will start when drip content is unlocked for a user', 'fchub-memberships'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Drip Content Unlocked', 'fchub-memberships'),
            'sub_title' => __('This will start when drip content is unlocked for a user', 'fchub-memberships'),
            'fields'    => [
                'subscription_status'      => [
    ...
    public function getConditionFields($funnel)
    {
        return [
            ...
            'run_multiple' => [
                ...
                'inline_help' => __('This trigger fires for each drip item. Enable to allow multiple runs per contact.', 'fchub-memberships'),
            ],
        ];
    }
    ...
    {
        // Hook signature: ($notification, $grant, $userId)
        $notification = $originalArgs[0];
        $grant = $originalArgs[1];
