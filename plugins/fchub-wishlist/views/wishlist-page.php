            ...
            <?php foreach ($items as $item) : ?>
                ...
                <div class="fchub-wishlist-item"
                    ...
                    <div class="fchub-wishlist-item__image">
                        ...
                        <?php else : ?>
                            <a href="<?= esc_url($permalink) ?>" class="fchub-wishlist-item__placeholder"></a>
                        <?php endif; ?>
                    </div>

                    <div class="fchub-wishlist-item__details">
                        <h3 class="fchub-wishlist-item__title">
                            <a href="<?= esc_url($permalink) ?>"><?= esc_html($item['product_title']) ?></a>
                        </h3>

                        <?php if (!empty($item['variant_title'])) : ?>
                            <span class="fchub-wishlist-item__variant"><?= esc_html($item['variant_title']) ?></span>
                        <?php endif; ?>
