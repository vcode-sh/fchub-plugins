...
class ItemRemovedTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fchub_wishlist/item_removed';
        $this->priority = 20;
        $this->actionArgNum = 4;
        parent::__construct();
    }
    ...
    public function getTrigger(): array
    {
        return [
            ...
            'label'       => __('Item Removed from Wishlist', 'fchub-wishlist'),
            'description' => __('This will start when an item is removed from a wishlist', 'fchub-wishlist'),
        ];
    }
    ...
    {
        return [
            'title'     => __('Item Removed from Wishlist', 'fchub-wishlist'),
            'sub_title' => __('This will start when an item is removed from a wishlist', 'fchub-wishlist'),
            'fields'    => [
                'subscription_status'      => [
