...
![Plans workspace showing plan health, readiness, search, and existing membership offers](/memberships/memberships-plans.webp)

## Guided Plan Builder

Choose **Memberships > Plans > Create Plan** to open the three-step builder:

![Guided plan builder showing offer details, three clear setup steps, and a live plan summary](/memberships/memberships-plan-builder.webp)
