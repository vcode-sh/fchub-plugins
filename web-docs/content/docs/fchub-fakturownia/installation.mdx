...
<Steps>
  <Step>
    ...
    Download the latest [`fchub-fakturownia.zip`](https://github.com/vcode-sh/fchub-plugins/releases/tag/fchub-fakturownia-v1.0.0) from GitHub. The zip file contains everything you need -- no additional dependencies or Composer steps required.
  </Step>
  <Step>
    ### Upload to WordPress
