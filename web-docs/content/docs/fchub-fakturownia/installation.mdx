...
<Steps>
  <Step>
    **Download the Plugin**
    ...
    Download the latest <PluginDownload plugin="fchub-fakturownia">fchub-fakturownia.zip</PluginDownload> from GitHub. The zip file contains everything you need -- no additional dependencies or Composer steps required.
  </Step>
  <Step>
    **Upload to WordPress**
