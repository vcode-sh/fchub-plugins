...
**What to do:** try again. If a download keeps failing its safety check, stop and tell us — that is exactly the signal the check exists to raise, and it should never happen twice.
