...
<Steps>
  ...
  <Step>
    **Prices change on the spot**

    No reload and no waiting: the browser already holds every rate the store offers, so product cards, cart totals and checkout switch together the moment you choose.
  </Step>
</Steps>
