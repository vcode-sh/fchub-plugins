...
<Cards>
  ...
  <Card title="Currency Blocks" href="/docs/fchub-multi-currency/blocks">
  ...
  <Card title="Instant Price Conversion" href="/docs/fchub-multi-currency/checkout">
    Choosing a currency converts every price on the spot — no reload, no request. Product cards, cart, checkout totals and pricing tables stay together, including later cart updates.
  </Card>
  ...
  <Card title="Remembers Preferences">
    Visitors pick a currency once. The plugin remembers it in the browser and, when signed in, in their account. A direct currency URL still wins for that visit. Come back next week, still in EUR.
  </Card>
  <Card title="First-Visit Locale Detection" href="/docs/fchub-multi-currency/configuration#detect-from-visitor-locale">
    A brand-new visitor can start on the currency their own timezone implies — entirely in the browser, no lookup service, nothing stored until they choose. Off by default.
  </Card>
  <Card title="Speaks 24 Languages" href="/docs/fchub-multi-currency/translations">
    Storefront, checkout notices, and the whole admin panel ship translated in 24 locales — with real native plural grammar, not the two-form approximation. Adding a language is one file and one command.
  </Card>
</Cards>
