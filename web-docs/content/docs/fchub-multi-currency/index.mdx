...
<Cards>
  ...
  <Card title="Instant Price Conversion" href="/docs/fchub-multi-currency/checkout">
    A confirmed currency switch reloads once with the right server context. Product cards, cart, checkout totals and pricing tables then stay together, including later cart updates.
  </Card>
