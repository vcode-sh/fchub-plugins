...
<Cards>
  <Card title="Download v1.0.0" href="https://github.com/vcode-sh/fchub-plugins/releases/tag/fchub-p24-v1.0.0">
    Download `fchub-p24-1.0.0.zip` from the GitHub release page.
  </Card>
</Cards>
