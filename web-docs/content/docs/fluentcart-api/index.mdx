...
<Cards>
  ...
  <Card title="Hooks Reference" href="/docs/fluentcart-api/hooks">
    Every action and filter hook FluentCart exposes. The extension points that make the whole thing actually customisable.
  </Card>
</Cards>
