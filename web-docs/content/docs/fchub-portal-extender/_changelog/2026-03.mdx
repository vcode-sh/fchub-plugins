...
Minimum PHP bumped to 8.1, minimum WordPress to 6.4. Functionally identical to v1.0.1. Your portal pages still work exactly the same — I just stopped pretending PHP 7.4 was acceptable.
