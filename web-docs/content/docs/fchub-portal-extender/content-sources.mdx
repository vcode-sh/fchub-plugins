...
Once you manually edit the slug field, auto-generation stops for that endpoint. The plugin assumes you know what you're doing at that point — a generous assumption, but that is where things stand.
