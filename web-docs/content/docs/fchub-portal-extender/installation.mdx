...
<Cards>
  <Card title="GitHub Releases" href="https://github.com/vcode-sh/fchub-plugins/releases">
    Download the latest `fchub-portal-extender-1.0.0.zip` from the Releases page.
  </Card>
</Cards>

Look for the asset named `fchub-portal-extender-1.0.0.zip` in the latest release. Download it to your computer.
...
Choose the `fchub-portal-extender-1.0.0.zip` file you downloaded and click **Install Now**.
</Step>
...
1. Extract `fchub-portal-extender-1.0.0.zip` on your local machine
