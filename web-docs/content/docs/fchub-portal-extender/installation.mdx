...
<Cards>
  <Card title="Download v1.0.0" href="https://github.com/vcode-sh/fchub-plugins/releases/tag/fchub-portal-extender/v1.0.0">
    Download `fchub-portal-extender-1.0.0.zip` from the GitHub release page.
  </Card>
</Cards>
