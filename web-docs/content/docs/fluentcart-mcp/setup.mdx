...
My server needs Node.js 22 or higher. Check what you've got:
...
Application Passwords have been built into WordPress since version 5.6. They let my server talk to your site's REST API without you handing over your actual login password. Sensible, that.
...
Use an **Administrator** account. My server needs admin access to do useful things. A limited-permission user will get 403 errors on nearly everything, which rather defeats the purpose.
</Callout>
...
<Tabs items={['Claude Desktop', 'Claude Code', 'Cursor', 'VS Code + Copilot', 'Windsurf', 'Codex CLI']}>
...
If you use multiple AI clients (or just hate repeating yourself), you can create one config file that my server reads automatically. Then your AI client configs don't need any credentials at all.
...
<Cards>
  ...
  <Card title="Tool Reference" href="/docs/fluentcart-mcp/tools">
    The full inventory of 200+ tools. Everything my server can do, listed by module.
  </Card>
</Cards>
