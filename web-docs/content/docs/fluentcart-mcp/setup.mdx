...
**1. Download [fluentcart-mcp.mcpb](https://github.com/vcode-sh/fchub-plugins/releases/download/fluentcart-mcp/v1.0.1/fluentcart-mcp.mcpb)** from the latest release.
