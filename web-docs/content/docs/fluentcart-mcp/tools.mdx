...
description: Every tool I built into FluentCart MCP, listed by module. 194 tools covering orders, products, customers, subscriptions, reports, and more.
---
...
<Accordion title="Customers (17 tools)">
...
<Accordion title="Coupons (11 tools)">
...
<Accordion title="Reports — Core (14 tools)">
...
<Accordion title="Reports — Insights (13 tools)">
...
| Customers | 17 | Profiles, addresses, stats |
| Subscriptions | 7 | Lifecycle management |
| Coupons | 11 | Discounts and promotions |
| Reports (Core + Insights) | 27 | Analytics and metrics |
...
| **Total (dynamic mode)** | **3** | Meta-tools that proxy to all 194 |
