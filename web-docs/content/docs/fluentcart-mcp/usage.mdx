...
description: How to talk to your FluentCart store through AI. 279 tools, plain English. What to ask, how to ask it, and what to expect back.
---
...
You just... talk. No special syntax. No commands to memorise. No tool names to remember. 279 tools with descriptions rich enough that any halfway decent AI can figure out which one to use from plain English. Describe what you want and let the AI sort it out.
...
279 tools is a lot, but let's not get delusional. There are limits:
...
<Cards>
  <Card title="Tool Reference" href="/docs/fluentcart-mcp/tools">
    All 279 tools, listed by module. The complete inventory.
  </Card>
