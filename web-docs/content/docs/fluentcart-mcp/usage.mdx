...
description: How to talk to your FluentCart store through AI. 274 tools, plain English. What to ask, how to ask it, and what to expect back.
---
...
<Cards>
  <Card title="Tool Reference" href="/docs/fluentcart-mcp/tools">
    All 274 tools, listed by module. The complete inventory.
  </Card>
