...
This server is for reading, analysis and reversible admin work. It does not move money or end
subscriptions. Use FluentCart's admin or official operator tooling for those jobs.
...
| **Refund or cancel** | Not in FluentCart MCP 2.0.0. Use FluentCart's admin or official operator tooling. |
