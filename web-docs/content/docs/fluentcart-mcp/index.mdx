...
| Requirement | Details |
|-------------|---------|
| **Node.js** | Version 22 or higher ([download](https://nodejs.org)) — *not needed for the Claude Desktop Extension* |
...
|--------|----------|-----------|
| **Claude Desktop (Extension)** | macOS, Windows | Download, double-click, done |
| **Claude Desktop (npx)** | macOS, Windows | Copy-paste some JSON |
