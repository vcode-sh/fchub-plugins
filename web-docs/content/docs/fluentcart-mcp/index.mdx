...
Download [fluentcart-mcp.mcpb](https://github.com/vcode-sh/fchub-plugins/releases/download/fluentcart-mcp/v1.0.1/fluentcart-mcp.mcpb), double-click, enter your WordPress credentials. Done. No Node.js, no JSON, no terminal.
