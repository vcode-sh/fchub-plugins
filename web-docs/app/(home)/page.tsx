...
import { mcpToolCount, versions } from "@/lib/versions";
              ...
              <CardContent className="flex items-center gap-3 py-3">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-xs">
                    {mcpToolCount} AI-agent tools for your FluentCart store.
                    Talk to your orders, products, and reports in plain English.
                  </CardDescription>
                </div>
