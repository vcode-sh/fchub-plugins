...
const listedToolCount = capabilities.reduce((sum, c) => sum + c.count, 0);
              ...
              <CardContent className="flex items-center gap-3 py-3">
                ...
                <div className="flex-1">
                  <CardTitle className="text-sm">
                    + {mcpToolCount - listedToolCount} more tools across
                    settings, integrations, labels, activity, and more
                  </CardTitle>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="gap-0 py-0">
              <CardContent className="py-4">
                ...
                <CardDescription className="text-xs">
                  Data from your store, translated into a human-friendly
                  response
                </CardDescription>
              </CardContent>
            </Card>
