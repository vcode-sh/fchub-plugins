/**
 * Search over the tool registry: the only interface a caller has in dynamic mode.
 *
 * The scoring lives in search-scoring.ts. This file turns a ranked list into rows.
 */
import type { ToolDefinition } from './_factory.js'
import { scoreTool } from './search-scoring.js'
import { type Category, inferCategory, prepareQuery } from './search-vocabulary.js'

// The scoring and the vocabulary moved into their own files. This surface stays exactly as it
// was, so nothing that imported from here has to know that they did.
export { matchScore, scoreTool } from './search-scoring.js'
export {
	CATEGORIES,
	type Category,
	inferCategory,
